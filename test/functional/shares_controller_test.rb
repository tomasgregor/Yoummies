...
class SharesControllerTest < ActionController::TestCase
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post :create, share: { food_id: @share.food_id, note: @share.note, picture: @share.picture, rating: @share.rating, thumbdown: @share.thumbdown, thumbup: @share.thumbup }
    end
  ...
  test "should update share" do
    put :update, id: @share, share: { food_id: @share.food_id, note: @share.note, picture: @share.picture, rating: @share.rating, thumbdown: @share.thumbdown, thumbup: @share.thumbup }
    assert_redirected_to share_path(assigns(:share))
  end
